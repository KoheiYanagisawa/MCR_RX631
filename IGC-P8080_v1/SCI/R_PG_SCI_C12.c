...
* Include      : 
*
* Declaration  : bool R_PG_SCI_Set_C12(void)
*
* Function Name: R_PG_SCI_Set_C12
*
...
bool R_PG_SCI_Set_C12(void)
{
	...
	res = R_SCI_Set(
		12,
		PDL_SCI_PIN_SCI12_SSCL12_PE2 | PDL_SCI_PIN_SCI12_SSDA12_PE1
	);
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_GenerateStopCondition_C12(void)
*
* Function Name: R_PG_SCI_I2CMode_GenerateStopCondition_C12
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_GetSentDataCount_C12(uint16_t * count)
*
* Function Name: R_PG_SCI_GetSentDataCount_C12
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_GetReceivedDataCount_C12(uint16_t * count)
*
* Function Name: R_PG_SCI_GetReceivedDataCount_C12
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_I2CMode_GetEvent_C12(bool * nack)
*
* Function Name: R_PG_SCI_I2CMode_GetEvent_C12
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_StopModule_C12(void)
*
* Function Name: R_PG_SCI_StopModule_C12
*
