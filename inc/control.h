...
#define SPEED_STRAIGHT			50	// 通常トレース
#define SPEED_CURVE_BRAKE		35	// カーブブレーキ
#define SPEED_CURVE_R600		45	// R600カーブ速度
#define SPEED_CURVE_R450		40	// R450カーブ速度
#define SPEED_CURVE_STRAIGHT	45	// S字カーブ直線速度

#define SPEED_CROSSLINE			    30	// クロスライン進入速度
#define SPEED_CLANK_TRACE			25	// クランク進入速度
#define SPEED_RIGHTCLANK_CURVE		25	// 右クランク旋回速度
#define SPEED_RIGHTCLANK_ESCAPE		30	// 右クランク復帰速度
#define SPEED_LEFTCLANK_CURVE		25	// 左クランク旋回速度
#define SPEED_LEFTCLANK_ESCAPE		30	// 左クランク復帰速度

#define SPEED_HALFLINE				43	// ハーフライン進入速度
...
// 角度
#define ANGLE_RIGHTCLANK		480	// 右クランク旋回角度480
#define ANGLE_LEFTCLANK		        -480	// 左クランク旋回角度480
#define ANGLE_RIGHTCHANGE		215	// 右レーンチェンジ旋回角度
#define ANGLE_LEFTCHANGE	        -215	    // 左レーンチェンジ旋回角度
...
#define SLOPE_LOWERLINE_IMU	    10		// 下り坂検出角度
