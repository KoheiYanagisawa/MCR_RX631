...
#define LEDG_ON		R_PG_IO_PORT_Write_PB2( 0 );
#define LEDG_OFF	R_PG_IO_PORT_Write_PB2( 1 );

#define LEDB_ON		R_PG_IO_PORT_Write_PB4( 0 );
#define LEDB_OFF	R_PG_IO_PORT_Write_PB4( 1 );
